...
uint32_t _getRandomNumber(uint32_t max)
{
	...
	*/
	...
	/*TODO: Implement Mersenne twister random number generator.
	I have an implementation lying around. need to copy-paste it
	*/

	return 4; //chosen by die roll. guaranteed to be random
}
